...
class TestProjectLoader(unittest.TestCase):
    ...
    def xtest_saving_project_with_one_plugin(self):
        yaml_handler = mock.MagicMock()
        filesystem = mock.MagicMock()
        loader = ProjectLoader(yaml_handler, filesystem)
        test_project = Project('Project')
    ...
    def xtest_adding_a_plugin_to_project_without_plugins(self):
        yaml_handler = mock.MagicMock()
        filesystem = mock.MagicMock()
        loader = ProjectLoader(yaml_handler, filesystem)
        new_plugin = Plugin('cest')
        yaml_handler.load.return_value = {
            'name': 'Project',
            'packages': {'cpm-hub': None},
        }
    ...
    def xtest_adding_a_plugin_to_project_with_plugins(self):
        yaml_handler = mock.MagicMock()
        filesystem = mock.MagicMock()
        loader = ProjectLoader(yaml_handler, filesystem)
        new_plugin = Plugin('fakeit')
        yaml_handler.load.return_value = {
            'name': 'Project',
            'packages': {'cpm-hub': None},
            'plugins': {'cest': '1.2'}
    ...
    def xtest_adding_a_plugin_to_project_with_previous_version_of_the_plugin(self):
        yaml_handler = mock.MagicMock()
        filesystem = mock.MagicMock()
        loader = ProjectLoader(yaml_handler, filesystem)
        new_plugin = Plugin('cest')
    ...
    def xtest_loading_project_with_one_action(self):
        yaml_handler = mock.MagicMock()
        filesystem = mock.MagicMock()
        yaml_handler.load.return_value = {
            'name': 'Project',
